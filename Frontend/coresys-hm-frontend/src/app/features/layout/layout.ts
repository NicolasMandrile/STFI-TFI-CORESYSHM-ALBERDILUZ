...
export class LayoutComponent {
  ...
  readonly navItems: { section: string | null; label: string; icon: string; route: string; permiso?: string }[] = [
    ...
    { section: 'Facturación',label: 'Nueva Factura', icon: 'file-text', route: '/facturacion/nueva' },
    { section: null,         label: 'Facturas',     icon: 'list',       route: '/facturacion' },
    ...
    { section: null,        label: 'Facturación',    icon: 'file-text',     route: '/reportes-facturacion' },
